...
Packaging before I had to move the Raspberry Pi
<Image src="/discovery/IMG_5448.jpeg" width={800} height={600} alt="Detail View" className="rounded-lg object-cover w-full" />
